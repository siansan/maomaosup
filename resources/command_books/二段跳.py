...
class key1(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key1!="" and int(runearrow.monster_())>=1:
            press(Key.key1, 1, nd=self.time)


class key2(Command):
    def __init__(self,nd,f=1):
        super().__init__(locals())
        self.time=nd
        self.fo=int(f)
    def main(self):
        if Key.key2!="" and int(runearrow.monster_())>=1:
            for i in range(self.fo):
                press(Key.key2, 1, nd=self.time)
...
class key3(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key3!="" and int(runearrow.monster_())>=1:
            press(Key.key3, 1, nd=self.time)
...
class key4(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key4!="" and int(runearrow.monster_())>=1:
            press(Key.key4, 1, nd=self.time)
...
class key5(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key5!="" and int(runearrow.monster_())>=1:
            press(Key.key5, 1, nd=self.time)
...
class key6(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key6!="" and int(runearrow.monster_())>=1:
            press(Key.key6, 1, nd=self.time)
...
class key7(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key7!="" and int(runearrow.monster_())>=1:
            press(Key.key7, 1, nd=self.time)
...
class key8(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key8!="" and int(runearrow.monster_())>=1:
            press(Key.key8, 1, nd=self.time)
...
class key9(Command):
    def __init__(self,nd):
        ...
        self.time=nd
    def main(self):
        if Key.key9!="" and int(runearrow.monster_())>=1:
            press(Key.key9, 1, nd=self.time)
