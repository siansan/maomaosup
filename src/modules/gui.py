...
from src.gui import Menu, View, Edit, Settings,Buff_skill
import icon
import os
import base64
import psutil
class GUI:
    ...
    def __init__(self):
        ...
        ico.write(base64.b64decode(icon.img)) # 寫一個icon出來
        ico.close()
        self.root = tk.Tk()
        self.root.title('毛毛輔助'+" "+f"PID={pid}")
        self.root.iconbitmap('unicorn.ico')
        ...
        self.buff_skill=Buff_skill(self.navigation)
